...
## Checklist
- [ ] Setup design system: import Montserrat + Inter dari Google Fonts di globals.css, update CSS variables untuk navy-gold palette, sync ke tailwind.config.ts
- [ ] Buat komponen Navbar dengan logo placeholder shield "Trans Security", menu links, tombol CTA "Minta Penawaran" gold, sticky dengan blur on scroll, hamburger menu mobile
- [ ] Hero section dengan 3 slides Ken Burns zoom animation (8 detik per slide), overlay gradient navy transparent, teks + CTA button tiap slide
- [ ] Section Statistics dengan 4 counter animations: 100+ Klien | 1000+ Personel | 10+ Tahun | 24/7 Operational
- [ ] Section Layanan Unggulan: 3 cards dengan icon, judul, deskripsi, hover lift + shadow + border gold
